...
import br.com.sample.mapsapp.models.Distance;
import br.com.sample.mapsapp.models.Duration;
...
public class DirectionsAPI {
    ...
    public DirectionsAPI(DirectionsAPIListener listener, String origin, String destination){
    ...
    private String createUrl() throws UnsupportedEncodingException {
        ...
        return DIRECTION_API_URL + "origin=" + urlOrigin + "&destination=" + urlDestination + "&key=" + SERVER_KEY;
    }
